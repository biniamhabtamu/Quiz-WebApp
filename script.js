...
const quizArray = [
	{
		id: "0",
		question: "I found________who could do the calulation.May be the question was tough.?",
		options: ["A.no one", "B.someone", "C.anyone", "D.everyone"],
		correct: "A.no one"
	},
	{
		id: "1",
		question: "I fell that__________loves me from the group,so I have to join another one.",
		options: ["A.everyone", "B.someone", "C.anyone", "D.no one"],
		correct: "D..no one"
	},
	{
		id: "2",
		question: " In fermentation:",
		options: ["A oxidative phosphorylation does not take place", "B substrate-level phosphorylation does take place", "C NAD is reduced in glycolysis", "D all of the above"],
	...
	},
{
		...
		id: "4",
		question: "ATP is an ideal energy transfer molecule in cells because?",
		options: ["A releases energy in small amounts", "B releases energy quickly", "C can move freely in, but not escape from, the cell", "D all of the above"],
		correct: "D all of the above"
}
